...
public enum MetricConstant {
    ...
    NOTIFICATION_REQUEST_RESPONSE_TIME("notification_request_response_time","Gauge for tracking notification requests response time", new String[]{"service", "notification-service", "controller", "notificationController"}),
